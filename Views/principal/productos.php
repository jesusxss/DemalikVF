                            ...
                            <div class="featured__item">
                                <div class="featured__item__pic set-bg" data-setbg="<?php echo BASE_URL . 'public/img/productos/' . $producto['imagen']; ?>">
                                    <ul class="featured__item__pic__hover">
                                        <li><a href="https://api.whatsapp.com/send?phone=<?php echo $data['negocio']['whatsapp'] . '&text=Productos= ' . $producto['nombre'] . ' Precio(S/ ' . $producto['precio'] . ')' ; ?>"  target="_blank"><i class="fa fa-whatsapp"></i></a></li>
                                ...
                                <div class="featured__item__text">
                                    ...
                                    <h5>S/<?php echo number_format($producto['precio'], 2); ?></h5>
                                </div>
                            </div>
                        </div>
                    <?php } ?>
                ...
                res.productos.forEach(producto => {
                    ...
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="${ ruta + 'public/img/productos/' + producto.imagen }">
                            <ul class="featured__item__pic__hover">
                                <li><a href="https://api.whatsapp.com/send?phone=${ res.negocio.whatsapp + '&text=Productos= ' + producto.nombre +  ' Precio(S/ ' + producto.precio + ')' }" target="_blank"><i class="fa fa-whatsapp"></i></a></li>
